...
const commands = [
    ...
    { name: 'setreportchannel', description: 'Set a channel to send reports to. This should be a channel that only moderators have access to.', default_member_permissions: MODERATE_PERM, options: [{ name: 'channel', description: 'The channel you want to set as the report channel', required: true, type: Constants.ApplicationCommandOptionTypes.CHANNEL }] },
    { name: 'report', description: 'Use this to report something to the moderators.', options: [{ name: 'reason', description: 'The reason for the report', required: true, type: Constants.ApplicationCommandOptionTypes.STRING }, { name: 'user', description: 'Optionally report a specific user', required: false, type: Constants.ApplicationCommandOptionTypes.USER }] },
