...
exports.helpCmd = function helpCmd(user,guild,interaction) {
    ...
    .setFields([
        { name: 'Moderation:', value: '`\`/ban [user] {reason}`\`, `\`/unban [user]`\`, `\`/kick [user] {reason}`\`, `\`/warn [user] [reason]`\`, `\`/cases [user]`\`, `\`/deletecase [case]`\`, `\`/setreportchannel [channel]`\`, `\`/report [reason] {user}`\`', inline: false },
