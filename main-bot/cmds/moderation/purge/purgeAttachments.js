...
exports.purgeAttachmentsCmd = async function purgeAttachmentsCmd(user,guild,interaction,count) {

    const cmdName = 'purge-attachments'
    ...
    const filteredMessages1 = messages.filter(m => m.attachments.size > 0)
    ...
    if (filteredMessages.length == 1) {
        embed.setTitle('Purge Attachment Messages')
