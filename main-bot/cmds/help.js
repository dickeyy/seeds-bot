...
exports.helpCmd = function helpCmd(user,guild,interaction) {
    ...
    .setFields([
        ...
        { name: 'Moderation', value:'`\`/ban`\`, `\`/unban`\`, `\`/kick`\`, `\`/warn`\`, `\`/cases`\`, `\`/deletecases`\`, `\`/setreportchannel`\`, `\`/report`\`, `\`/log set_channel`\`, `\`/log toggle`\`,`\`/purge all`\`, `\`/purge user`\`, `\`/purge contains`\`, `\`/purge attachments`\`, `\`/purge bot`\`, `\`/purge embeds`\`, `\`/purge emoji`\`, `\`/purge seeds`\`', inline: false },
